...
#ifndef NUM_ELEMENTS
#define NUM_ELEMENTS		8 * 1024*1024
#endif

#ifndef NMB
#define	NMB			NUM_ELEMENTS/(1024.0*1024.0)
#endif
...
const char *			CL_FILE_NAME = { "src/third.cl" };
...
main( int argc, char *argv[ ] )
{
	...
	float gigamults = (double)NUM_ELEMENTS/(time1-time0)/1000000000. ;
	// fprintf(stderr, "%lf\t%d\t%10d\t%10.3lf GigaMultsPerSecond\n",NMB, LOCAL_SIZE, NUM_WORK_GROUPS, gigamults );
	fprintf(stderr, "%d,%lf,%d,%d,%lf\n", NUM_ELEMENTS, NMB, LOCAL_SIZE, NUM_WORK_GROUPS, gigamults );
