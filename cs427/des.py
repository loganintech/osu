...
if __name__ == '__main__':
    key = "secret_k"
    text=  str(0b100000000000000000000000000000000000000000000000000)
    print(len(text))
    d = des()
    r = d.encrypt(key,text)
    r2 = d.decrypt(key,r)
    print(f"Ciphered: {''.join(map(bin, bytearray(r, 'utf8')))}")
    print(f"Deciphered: {''.join(map(bin, bytearray(r2, 'utf8')))}")
