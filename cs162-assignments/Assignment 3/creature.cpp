...
** Author: Logan Saso
** Date: May 14th
** Description: Creature Class Implementations
...
*********************************************************************/ 
int Creature::get_damage_max() const
{
	return _damage_max;
}
...
*********************************************************************/ 
void Creature::set_health(const int health)
{
	_health = health;
}
...
*********************************************************************/ 
void Creature::set_damage_max(const int damage_max)
{
	_damage_max = damage_max;
}
